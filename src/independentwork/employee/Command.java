...
public interface Command {
    ...
    static void printCommands() {
        ...
        System.out.println("please input" + SEARCH_EMPLOYEE_BY_SALARY_RANGE + " for search employee by company name");
        System.out.println("please input "  + SEARCH_EMPLOYEE_BY_COMPANY_ID + " for search employee by salary range");
